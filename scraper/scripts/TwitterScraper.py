...
from scraper.twscrape.utils import gather
from scraper.twscrape.account import Account
from scraper.twscrape.db import fetchall, fetchone, execute
from scraper.twscrape import API, gather, Tweet
from scraper.twscrape.models import parse_tweets
from scraper.my_utils.upload_to_s3 import upload_to_s3
from scraper.my_utils.upload_to_s3.upload_to_s3 import upload_to_s3
from scraper.my_utils.folder_manipulation import save_to_jsonl
from scraper.my_utils.logger import logger
from scraper.my_utils.meo_api.update_crawler_history import update_crawler_history
from scraper.hti import HumanTwitterInteraction, HTIOutput
...
class TwitterScraper:
    ...
    async def instantiate_twscrape_api(self):
        ...
        self.api: API | None = API(pool=os.path.join("/data/db", "accounts.db"),
