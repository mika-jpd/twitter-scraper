...
class UserRef(JSONTrait):
    ...
    username: str
    displayname: str
    _type: str = "snscrape.modules.twitter_api_client.UserRef"
...
class User(JSONTrait):
    ...
    _type: str = "snscrape.modules.twitter_api_client.User"
...
class Tweet(JSONTrait):
    ...
    _type: str = "snscrape.modules.twitter_api_client.Tweet"
